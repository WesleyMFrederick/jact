 ...
 *   - ParsedDocumentLifecycleLike: AnchorMatcher.ts (used by AnchorMatcher, CitationValidator)
...
export type { BacklinkCandidateFilterLike } from "../core/LinkedHeaderContext/BacklinkCandidateFilter.js";
