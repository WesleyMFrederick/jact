...
- **Research Whiteboard**: `typescript-restoration-whiteboard.md` - Comprehensive analysis
- **Type Audit**: `typescript-type-contract-audit.md` - Contract violations documented
- **Architecture Doc**: `architecture-citation-manager.md` - Correct contracts
